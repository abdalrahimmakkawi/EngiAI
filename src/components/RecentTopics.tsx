...
export const RecentTopics: React.FC = () => {
  ...
  return (
    <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="eng-card rounded-2xl p-5 flex flex-col shadow-2xl flex-1 overflow-hidden"
    >
      ...
      <div className="space-y-3 flex-1 overflow-y-auto pr-1">
        {topics.map((topic) => (
          <motion.div 
            ...
            className="p-3 rounded-xl bg-[#1a1a2e]/30 border border-white/5 cursor-pointer hover:border-accent/40 transition-all group"
          >
